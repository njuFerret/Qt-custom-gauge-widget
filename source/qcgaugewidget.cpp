...
QcGaugeWidget::QcGaugeWidget(QWidget *parent) : QWidget(parent) { setMinimumSize(250, 250); }
...
int QcGaugeWidget::removeItem(QcItem *item) { return mItems.removeAll(item); }

QList<QcItem *> QcGaugeWidget::items() { return mItems; }
...
int QcItem::type() { return 50; }

void QcItem::update() { parentWidget->update(); }

float QcItem::position() { return mPosition; }

QRectF QcItem::rect() { return mRect; }
...
void QcBackgroundItem::clearrColors() { mColors.clear(); }



QcGlassItem::QcGlassItem(QObject *parent) : QcItem(parent) { setPosition(88); }
...
float QcLabelItem::angle() { return mAngle; }
...
QString QcLabelItem::text() { return mText; }
...
QColor QcLabelItem::color() { return mColor; }



QcArcItem::QcArcItem(QObject *parent) : QcScaleItem(parent) {
  setPosition(80);
  mColor = Qt::black;
}
...
void QcArcItem::setColor(const QColor &color) { mColor = color; }


QcColorBand::QcColorBand(QObject *parent) : QcScaleItem(parent) {
  QColor tmpColor;
...
void QcColorBand::draw(QPainter *painter) {
  ...
  for (int i = 0; i < mBandColors.size(); i++) {
    ...
    QColor clr = mBandColors.at(i).first;
    float sweep;
    if (i == 0)
      sweep = getDegFromValue(mBandColors.at(i).second) - getDegFromValue(mMinValue);
    else
      sweep = getDegFromValue(mBandColors.at(i).second) - getDegFromValue(mBandColors.at(i - 1).second);
...
void QcNeedleItem::draw(QPainter *painter) {
  ...
  switch (mNeedleType) {
  case QcNeedleItem::FeatherNeedle: createFeatherNeedle(getRadius(tmpRect)); break;
  case QcNeedleItem::DiamonNeedle: createDiamonNeedle(getRadius(tmpRect)); break;
  case QcNeedleItem::TriangleNeedle: createTriangleNeedle(getRadius(tmpRect)); break;
  case QcNeedleItem::AttitudeMeterNeedle: createAttitudeNeedle(getRadius(tmpRect)); break;
...
float QcNeedleItem::currentValue() { return mCurrentValue; }
...
QColor QcNeedleItem::color() { return mColor; }
...
QcLabelItem *QcNeedleItem::label() { return mLabel; }
...
QcValuesItem::QcValuesItem(QObject *parent) : QcScaleItem(parent) {
  setPosition(70);
  mColor = Qt::black;
  mStep = 10;
}
...
void QcValuesItem::setStep(float step) { mStep = step; }

void QcValuesItem::setColor(const QColor &color) { mColor = color; }
